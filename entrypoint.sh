...
if [ -w /etc/hosts ]; then
    ...
    export CHROME_HOST_RULES="MAP rewards.bing.com 23.33.40.136,MAP www.bing.com 23.33.40.136,MAP account.microsoft.com 23.33.40.136,MAP prod.rewardsplatform.microsoft.com 48.194.5.88"
fi
